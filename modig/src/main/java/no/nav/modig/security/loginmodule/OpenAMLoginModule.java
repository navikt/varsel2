...
public class OpenAMLoginModule implements LoginModule {
    ...
    public void initialize(Subject subject, CallbackHandler callbackHandler, Map<String, ?> sharedState, Map<String, ?> options) {
        ...
        logger.debug("Initializing with subject: " + subject +
        	...
        	logger.error("Error while trying to create Scheme"  + unsupportedSchemeException);
        }
    }
    ...
    protected UserInfoService createUserInfoService() throws UnsupportedSchemeException {
