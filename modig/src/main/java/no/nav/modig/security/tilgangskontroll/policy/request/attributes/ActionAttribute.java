...
/**
 * Attribute of the action to be performed on the resource.
 * <p/>
 ...
 */
public class ActionAttribute extends PolicyAttribute {

    public ActionAttribute(URN attributeId, final AttributeValue<?> attributeValue) {
        super(attributeId, attributeValue);
    }

    @Override
    public PolicyAttribute resolvedCopy() {
        return new ActionAttribute(getAttributeId(), getAttributeValue().getResolvedCopy());
    }

	public String toLogString() {
		return  "Action= " + logDescribeAttributes();
	}

    @Override
    public String toString() {
        return "ActionAttribute{" + describeAttributes() + '}';
    }
}
